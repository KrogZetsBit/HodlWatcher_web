...
MIGRATION_MODULES = {"sites": "hodlwatcher.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "hodlwatcher.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""KrogZetsBit""", "krogzetsbit@example.com")]
...
ACCOUNT_USERNAME_BLACKLIST = [
    ...
    "root",
    "superuser",
]  # No permitir estos usernames
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "hodlwatcher.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "hodlwatcher.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "hodlwatcher.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "hodlwatcher.users.forms.UserSocialSignupForm"}
